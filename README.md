...
*The user won the game by cracking the color code in four attempts. The counter in the top left corner now displays the number of attempts used. If the code is not cracked within 12 attempts, it's game over for the user. In that case, this green result card reading "Congratulations!" is replaced with a red result card reading "Too bad!".*
