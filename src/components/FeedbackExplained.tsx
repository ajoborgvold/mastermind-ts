...
const FeedbackExplained: FC = () => {
  return (
    <div className="self-center flex flex-col gap-1 bg-stone-200 dark:bg-stone-700 p-4 sm:px-8 rounded-lg">
      ...
      <div className="flex items-center gap-2">
        <div className="w-4 h-4 lg:w-5 lg:h-5 flex justify-center items-center text-teal-950 dark:text-white text-xs lg:text-sm border border-teal-950 dark:border-stone-50 rounded-full">
          N
        </div>
        <p>= No color match</p>
      </div>
