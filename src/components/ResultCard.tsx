...
export default function ResultCard({cardStyle, p1, p2}: ResultCardProps): JSX.Element {
  ...
  return (
    <div
      className={`mt-6 flex flex-col items-center gap-3 sm:gap-4 ${cardStyle} mb-4 px-4 sm:px-8 py-4 border-2 border-stone-950 shadow-[0_0_12px_3px_rgb(253,230,138)] rounded-md`}
    >
